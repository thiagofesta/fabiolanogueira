...
jQuery(document).ready(function() {
	// initiate googlemaps					
    jQuery('#map').goMap({ address: 'Rua Dom Pedro II, 394, Centro, Toledo, Parana, 85904-175',
	    	zoom: 16,
	    	navigationControl: true, 
	    	maptype: 'TERRAIN',
	    	draggable: false, zoomControl: false, scrollwheel: false, disableDragging: true,
	    	markers: [
	    		{ 'address' : 'Rua Dom Pedro II, 394, Centro, Toledo, Parana, 85904-175' }
	    	],
			
        disableDoubleClickZoom: true
		});

var styles = [ { "stylers": [ { "visibility": "on" }, { "saturation": -20 }, { "gamma": 0 } ] },{ } ];
